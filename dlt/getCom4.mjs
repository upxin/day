...
const allPossibleCombinations = getCombinations(allNumbers, 4).map((combo) =>
...
// 写入文件 - 生成的组合
fs.writeFile("all4.mjs", outputContent, "utf8")
  .then(() => {
...
// 写入文件 - 剩余的组合
fs.writeFile("rest4.mjs", restOutputContent, "utf8")
  .then(() => {
